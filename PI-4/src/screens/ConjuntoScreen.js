...
export default function ConjuntoScreen() {
  ...
  const carregarProdutos = async () => {
    try {
      ...
      // A PENEIRA: Guarda apenas os Conjuntos (ID 3)
      const apenasConjuntos = data.filter(item => item.fk_id_categoria === 3);
      setProdutos(apenasConjuntos);
  ...
  if (loading) {
    return (
      <View style={styles.loading}>
        ...
        <Text style={{ marginTop: 10 }}>Carregando Conjuntos...</Text>
      </View>
    );
  }
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={goToHome}>
            <Text style={styles.logoText}>Setor de Conjuntos</Text>
          </TouchableOpacity>
        ...
        <ContainerSecao>
          <Text style={styles.sectionTitle}>Conjuntos em Promoção</Text>
        ...
        <ContainerSecao>
          <Text style={styles.sectionTitle}>Conjuntos Mais Vendidos</Text>
        ...
        <ContainerSecao>
          <Text style={styles.sectionTitle}>Novos Conjuntos</Text>
